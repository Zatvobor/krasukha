...
{:ok, _btc_dash_market, _state} = Krasukha.start_market!("BTC_XRP")
...
params = %{fulfill_immediately: true, currency_pair: "BTC_XRP", stop_rate: 0.00000732, limit_amount: 15}
Krasukha.start_exchange_routine(agent, :buy_lowest, params)
params = %{sleep_time_inactive: 120, currency_pair: "BTC_XRP", stop_rate: 0.00000725, limit_amount: 15}
